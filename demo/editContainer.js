...
export default class EditContainer extends Component {
    componentDidMount() {
        ...
        this.wEditor.setContents({"ops":[{"insert":"从前慢 - 刘胡轶"},{"attributes":{"align":"center","header":2},"insert":"\n"},{"attributes":{"color":"#f79646"},"insert":"词：木心 "},{"insert":"\n"},{"attributes":{"width":"371"},"insert":{"image":"http://mssdn.sankuai.com/v1/mss_814dc1610cda4b2e8febd6ea2c809db5/image/1493713913846.png"}},{"attributes":{"align":"center"},"insert":"\n"},{"insert":"记得早先少年时"},{"attributes":{"lineHeight":"3"},"insert":"\n"},{"insert":"大"},{"attributes":{"comments":"1"},"insert":"家诚诚"},{"insert":"恳恳\n说一句 是一句\n清早上火车站"},{"attributes":{"lineHeight":"3"},"insert":"\n"},{"insert":"长街黑暗无行人\n卖豆浆的小店"},{"attributes":{"link":"https://www.baidu.com"},"insert":"冒着热气"},{"insert":"\n从前的"},{"attributes":{"comments":"2"},"insert":"日色"},{"insert":"变得慢从前的日色变得慢从前的日色变得慢从前的日色变得慢从前的日色变得慢从前的"},{"attributes":{"comments":"3"},"insert":"日色变得慢从"},{"insert":"前的日色变得慢从前的日色变得慢\n车 马 邮件都慢\n一生只够爱一个人\n从前的锁也好看\n钥匙精美有样子\n你锁了\n人家就懂了\n从前的日色变得慢\n车 马 邮件都慢\n一生只够爱一个人\n从前的锁也好看\n钥匙精美有样子\n你锁了\n人家就懂了\n"}]});
    }
