...
export default class EditContainer extends Component {
    componentDidMount() {
        let quillEditor = window.quillEditor = this.wEditor.getEditor();
        ...
        this.wEditor.getEditor().on('text-change',(range)=>{
            ...
            if(_range){
                cursorsModule.setCursor(
                    '1',
                    {index:_range.index-3,length:_range.length},
                    'yeanzhi',
        ...
        //this.wEditor.setContents({"ops":[{"insert":"1.单个文件分享下载  未转码。\n"},{"attributes":{"strike":true},"insert":"2.列表页文件更名和文档回写冲突，造成无法更名。"},{"insert":"\n3.协作文件被更名后，列表页操作会提示节点不存在。\n"},{"attributes":{"strike":true},"insert":"4.app端点击分享链接，文案修改。"},{"insert":"\n5.编辑「我的文件」里的脑图 ，header部分貌似不对。"},{"attributes":{"code-block":true},"insert":"\n"},{"insert":"6.脑图新建人没有自动关注（已解决）。"},{"attributes":{"code-block":true},"insert":"\n"},{"insert":"7.某些文档无法添加格式（这个文档不行，其它可以）。"},{"attributes":{"code-block":true},"insert":"\n"}]});
        this.wEditor.setContents({"ops":[{"insert":"1.单个文件分享下载  未转码。\n"},{"attributes":{"strike":true},"insert":"2.列表页文件更名和文档回写冲突，造成无法更名。"},{"insert":"\n3.协作文件被更名后，列表页操作会提示节点不存在。\n"},{"attributes":{"strike":true},"insert":"4.app端点击分享链接，文案修改。"},{"insert":"\n5.编辑「我的文件」里的脑图 ，header部分貌似不对。"},{"insert":"\n"},{"insert":"6.脑图新建人没有自动关注（已解决）。"},{"insert":"\n"},{"insert":"7.某些文档无法添加格式（这个文档不行，其它可以）。"},{"insert":"\n"}]});
    }
    ...
    render() {
        return(
            <div>
                ...
                coCursors = {[{name:'yeanzhi',range:{length:1,index:48},id:'123'}]}
                options={{
