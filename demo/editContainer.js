...
export default class EditContainer extends Component {
    componentDidMount() {
        ...
        this.wEditor.setContents({
            "ops": [{"insert": "从前慢 - 刘胡轶"}, {
                "attributes": {"align": "center", "header": 2},
                "insert": "\n"
            }, {"attributes": {"color": "#f79646"}, "insert": "词：木心 "}, {"insert": "\n"}, {
                "attributes": {"width": "371"},
                "insert": {"image": "http://mssdn.sankuai.com/v1/mss_814dc1610cda4b2e8febd6ea2c809db5/image/1493713913846.png"}
            }, {
    ...
    render() {
        return (
            <div>
                <WEditor
                    doc={{
                        name: 'test.doc', status: 'fjdisoaifasdof'
                    }}
                    ref={(e) => {
                        this.wEditor = e;
                    }}
                    ...
                    options={{
                        ...
                        helpOptions: [
                            {
                                key: 'nihao', content: 'nihaoa', onClick: (key) => {
                                console.log(key);
                            }
                            }
                        ],
