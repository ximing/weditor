                    ...
                    <ColorPicker onChangeComplete={this.setColor} defaultColor={color} icon={(
                        <span className="ql-defalut-color">
                            <svg viewBox="0 0 18 18">
                                ...
                                <polyline className="ql-stroke" points="5.5 11 9 3 12.5 11" style={{stroke: color === '#FFFFFF' ? '#000000' : color}}></polyline>
                                <line className="ql-stroke" x1="11.63" x2="6.38" y1="9" y2="9" style={{stroke: color === '#FFFFFF' ? '#000000' : color}}></line>
                            </svg>
                        </span>
                    )}/>
                </span>
